...
export const getAllIdeas = async () => {
    ...
    try {
        return await Idea.find().populate('ideaCategoryId ideaStageId functionId subdivisionId createdBy updatedBy coauthors');
    } catch (err) {
...
export const getIdeaById = async (id) => {
    ...
    try {
        return await Idea.findById(id).populate('ideaCategoryId ideaStageId functionId subdivisionId createdBy updatedBy coauthors');
    } catch (err) {
...
export const updateIdea = async (id, ideaData) => {
    ...
    try {
        return await Idea.findByIdAndUpdate(id, ideaData, { new: true }).populate('ideaCategoryId ideaStageId functionId subdivisionId createdBy updatedBy coauthors');
    } catch (err) {
