...
export const createIdeaController = async (req, res) => {
    try {
        ...
        res.status(HttpStatusCodes.CREATED.code).json({
            status: true,
            message: responseStrings.createIdeaSuccessMessage,
            data: createdIdea,
        });
    } catch (error) {
        ...
        res.status(HttpStatusCodes.INTERNAL_SERVER_ERROR.code).json({
            status: false,
            message: responseStrings.createIdeaErrorMessage,
        });
    }
};
...
export const getAllIdeasController = async (req, res) => {
    try {
        ...
        res.status(HttpStatusCodes.OK.code).json({
            status: true,
            message: responseStrings.getAllIdeaSuccessMessage,
            data: updatedIdeas,
        });
    } catch (error) {
        ...
        res.status(HttpStatusCodes.INTERNAL_SERVER_ERROR.code).json({
            status: false,
            message: responseStrings.getAllIdeaErrorMessage,
        });
    }
};
...
export const getIdeaByIdController = async (req, res) => {
    try {
        ...
        res.status(HttpStatusCodes.OK.code).json({
            status: true,
            message: responseStrings.getIdeaByIdSuccessMessage,
            data: data,
        });
    } catch (error) {
        ...
        res.status(HttpStatusCodes.INTERNAL_SERVER_ERROR.code).json({
            status: false,
            message: responseStrings.getIdeaByIdErrorMessage,
        });
    }
};
...
export const updateIdeaController = async (req, res) => {
    try {
        ...
        res.status(HttpStatusCodes.OK.code).json({
            status: true,
            message: responseStrings.updateIdeaSuccessMessage,
            data: updatedIdea,
        });
    } catch (error) {
        ...
        res.status(HttpStatusCodes.INTERNAL_SERVER_ERROR.code).json({
            status: false,
            message: responseStrings.updateIdeaErrorMessage,
        });
    }
};
...
export const deleteIdeaController = async (req, res) => {
    try {
        ...
        res.status(HttpStatusCodes.NO_CONTENT.code).json({
            status: true,
            message: responseStrings.deleteIdeaSuccessMessage,
        });
    } catch (error) {
        logger.error(`Error deleting idea: ${error.message}`);
        res.status(HttpStatusCodes.INTERNAL_SERVER_ERROR.code).json({
            status: false,
            message: responseStrings.deleteIdeaErrorMessage,
        });
    }
};
...
export const filterIdeasController = async (req, res) => {
    try {
        const { stageId, verticalId, authorId, functionId, demoDayId } = req.body;
        ...
        if (authorId && author) query.createdBy = author._id;
        if (functionId) query.functionId = functionId;
        if (demoDayId) query.demoDayId = demoDayId;
        ...
        res.status(HttpStatusCodes.OK.code).json({
            status: true,
            message: responseStrings.filterIdeaSuccessMessage,
            data: updatedIdeas,
        });
    } catch (error) {
        logger.error(`Error fetching ideas: ${error.message}`);
        res.status(HttpStatusCodes.INTERNAL_SERVER_ERROR.code).json({
            status: false,
            message: responseStrings.filterIdeaErrorMessage,
        });
    }
};
